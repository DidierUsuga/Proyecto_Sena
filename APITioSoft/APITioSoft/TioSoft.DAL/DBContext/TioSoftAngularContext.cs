...
public partial class TioSoftAngularContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C44F6969F");
        ...
        {
            entity.HasKey(e => e.IdCompra).HasName("PK__Compra__48B99DB7037CF433");
        ...
        {
            entity.HasKey(e => e.IdDetalleCompra).HasName("PK__DetalleC__62C252C11AE01C1B");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843FF907DA3E");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483487C1650");
        ...
        {
            entity.HasKey(e => e.IdMenuRol).HasName("PK__MenuRol__9D6D61A4957F0177");
        ...
        {
            entity.HasKey(e => e.IdNumeroDocumento).HasName("PK__NumeroDo__471E421A2C04C1E7");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A13284D5CD74");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76D6B64AD7");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6EF60B220");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D56145DD637A7");
